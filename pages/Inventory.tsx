...
const RumCard: React.FC<{ rum: Rum, onToggle: () => void }> = ({ rum, onToggle }) => (
  <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-amber-100 flex flex-col justify-between hover:shadow-xl transition-all hover:border-b-amber-700">
